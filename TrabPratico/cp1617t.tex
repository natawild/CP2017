...
\begin{eqnarray*}
\start
\ensuremath{\begin{lcbr}\Varid{wc\char95 w}\comp \Varid{nil}\mathrel{=}\underline{\mathrm{0}}\\\Varid{wc\char95 w}\comp \Varid{cons}\mathrel{=}\Varid{cond}\;\Varid{p}\;(\succ \comp \Varid{wc\char95 w}\comp \p2)\;(\Varid{wc\char95 w}\comp \p2)\end{lcbr}}
\end{eqnarray*}
...
\just={ justificação ..... }
%
        \ensuremath{\Varid{alpha}\comp \conj{\Varid{p}\comp \Varid{f}}{\Varid{f}}}
%
\just={ justificação ..... }
%
        \ensuremath{\Varid{alpha}\comp (\Varid{id}\times\Varid{f})\comp \conj{\Varid{p}\comp \Varid{f}}{\Varid{id}}}
%
      ---- etc -----
%
\end{eqnarray*}
