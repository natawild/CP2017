...
\\
\>[B]{}\mathbf{import}\;\Conid{Probability}\;\Varid{hiding}\;(\mcond{\cdot }{\cdot }{\cdot },\Varid{choose}){}\<[E]%
\\
...
\\
\>[8]{}\hsindent{3}{}\<[11]%
\>[11]{}\Varid{sep}\;\Varid{c}\mathrel{=}\Varid{c}\in \text{\tt \char34 ~\char92 r\char92 n\char92 t\char92 v\char92 f\char92 160\char34}{}\<[E]%
\\
\>[8]{}\hsindent{3}{}\<[11]%
...
\column{11}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inv}\mathbin{::}\Conid{Double}\to \Conid{Int}\to \Conid{Double}{}\<[E]%
\\
\>[B]{}\Varid{inv}\;\Varid{x}\;\Varid{n}\mathrel{=}\p2\mathbin{\$}\mathsf{for}\ (\Varid{invAccum}\;\Varid{x})\ (\mathrm{0},\mathrm{0})\;\Varid{n}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{invAccum}\mathbin{::}\Conid{Double}\to (\Conid{Double},\Conid{Double})\to (\Conid{Double},\Conid{Double}){}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{invAccum}\;\Varid{x}\;(\Varid{it},\Varid{accum})\mathrel{=}(\Varid{it}\mathbin{+}\mathrm{1},\Varid{accum}\mathbin{+}(\mathrm{1}\mathbin{-}\Varid{x})\mathbin{**}\Varid{it}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{11}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{prop\char95 inv\char95 correctness}\mathbin{::}\Conid{NonNegative}\;\Conid{Int}\to \Conid{Property}{}\<[E]%
\\
\>[B]{}\Varid{prop\char95 inv\char95 correctness}\;(\Conid{NonNegative}\;\Varid{n})\mathrel{=}\Varid{forAll}\;(\Varid{choose}\;(\mathrm{1},\mathrm{1.999}))\mathbin{\$}\lambda \Varid{x}\to \Varid{diff}\;\Varid{n}\;\Varid{x}\mathbin{>}\Varid{tolerance}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{diff}\mathbin{::}\Conid{Int}\to \Conid{Double}\to \Conid{Double}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{diff}\;\Varid{n}\;\Varid{x}\mathrel{=}\Varid{abs}\mathbin{\$}\Varid{x}\mathbin{-}(\Varid{inv}\;\Varid{x}\;\Varid{n}){}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{tolerance}\mathrel{=}\mathrm{0.0001}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{tabbing}\tt
~float~inv\char40{}float~x\char44{}~int~n\char41{}\char123{}\\
\tt ~~~~~float~accum~\char61{}~0\char59{}\\
\tt ~~~~~for\char40{}int~i~\char61{}~0\char59{}~i~\char60{}~n\char59{}~i\char43{}\char43{}\char41{}\char123{}\\
\tt ~~~~~~~~~accum~\char43{}\char61{}~pow\char40{}1~\char45{}~x\char44{}~i\char41{}\char59{}\\
\tt ~~~~~\char125{}\\
\tt ~~~~~return~accum\char59{}\\
\tt ~\char125{}
\end{tabbing}
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{wrapper}\mathbin{::}\Varid{a}\times\Varid{b}\to \Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{wrapper}\mathrel{=}\p2{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{worker}\mathbin{::}[\mskip1.5mu \Conid{Char}\mskip1.5mu]\to (\Conid{Bool},\Conid{Int}){}\<[E]%
\\
\>[B]{}\Varid{worker}\mathrel{=}\Varid{cataList}\;\alt{\underline{(\Conid{True},\mathrm{0})}}{\Varid{wordAccum}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{wordAccum}\mathbin{::}(\Conid{Char},(\Conid{Bool},\Conid{Int}))\to (\Conid{Bool},\Conid{Int}){}\<[E]%
\\
\>[B]{}\Varid{wordAccum}\;(\Varid{a},(\Varid{b},\Varid{n})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{b}\mathrel{\wedge}(\neg \comp \Varid{sep})\;\Varid{a}\mathrel{=}(\Varid{sep}\;\Varid{a},\succ \;\Varid{n}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{otherwise}\mathrel{=}(\Varid{sep}\;\Varid{a},\Varid{n}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{sep}\mathbin{::}\Conid{Char}\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{sep}\;\Varid{c}\mathrel{=}\Varid{c}\in \text{\tt \char34 ~\char92 r\char92 n\char92 t\char92 v\char92 f\char92 160\char34}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{prop\char95 wc\char95 w\char95 correctness1}\mathbin{::}\Conid{String}\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{prop\char95 wc\char95 w\char95 correctness1}\;\Varid{str}\mathrel{=}\length \;(\Varid{words}\;\Varid{str})\equiv \Varid{wc\char95 w\char95 final}\;\Varid{str}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{prop\char95 wc\char95 w\char95 correctness2}\mathbin{::}\Conid{String}\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{prop\char95 wc\char95 w\char95 correctness2}\;\Varid{str}\mathrel{=}\Varid{wc\char95 w}\;\Varid{str}\equiv \Varid{wc\char95 w\char95 final}\;\Varid{str}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{prop\char95 worker\char95 first}\mathbin{::}\Conid{String}\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{prop\char95 worker\char95 first}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[B]{}\Varid{prop\char95 worker\char95 first}\;\Varid{str}\mathord{@}(\Varid{c}\mathbin{:\char95 })\mathrel{=}\Varid{sep}\;\Varid{c}\equiv (\p1\;(\Varid{worker}\;\Varid{str})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\start
\ensuremath{\begin{lcbr}\Varid{wc\char95 w}\comp \Varid{nil}\mathrel{=}\underline{\mathrm{0}}\\\Varid{wc\char95 w}\comp \Varid{cons}\mathrel{=}\mcond{\Varid{x}}{(\succ \comp \Varid{wc\char95 w}\comp \p2)}{(\Varid{wc\char95 w}\comp \p2)}\end{lcbr}}
\end{eqnarray*}
...
\begin{eqnarray*}
\start
        \ensuremath{\Varid{x}\mathrel{=}\uncurry{(\mathrel{\wedge})}\comp \conj{\neg \comp \Varid{sep}\comp \p1}{\Varid{look}\comp \p2}}
\just={ Absorção-X (11)}
        \ensuremath{\Varid{x}\mathrel{=}\uncurry{(\mathrel{\wedge})}\comp (\neg \comp \Varid{sep}\times\Varid{look})\comp \conj{\p1}{\p2}}
\just={ Reflexão-X (8)}
        \ensuremath{\Varid{x}\mathrel{=}\uncurry{(\mathrel{\wedge})}\comp (\neg \comp \Varid{sep}\times\Varid{look})}
\end{eqnarray*}
...
\start
\just={ Eq- + (27)}
        \ensuremath{\Varid{wc\char95 w}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{0}}}{\mcond{(\uncurry{(\mathrel{\wedge})}\comp (\neg \comp \Varid{sep}\times\Varid{look}))}{(\succ \comp \Varid{wc\char95 w}\comp \p2)}{(\Varid{wc\char95 w}\comp \p2)}}}
\just={ \ensuremath{\Varid{look}\mathrel{=}\p1\comp \conj{\Varid{look}}{\Varid{wc\char95 w}}} e \ensuremath{\Varid{wc\char95 w}\mathrel{=}\p2\comp \conj{\Varid{look}}{\Varid{wc\char95 w}}} }
        \ensuremath{\Varid{wc\char95 w}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{0}}}{\begin{array}{ll}\multicolumn{2}{l}{\uncurry{(\mathrel{\wedge})}\comp (\neg \comp \Varid{sep}\times\p1\comp \conj{\Varid{look}}{\Varid{wc\char95 w}})\to }\\& \succ \comp \p2\comp (\conj{\Varid{look}}{\Varid{wc\char95 w}}\comp \p2),\\& \p2\comp (\conj{\Varid{look}}{\Varid{wc\char95 w}}\comp \p2)\end{array}}}
\just={ Functor- X (14), Natural \ensuremath{\p2} (13)}
        \ensuremath{\Varid{wc\char95 w}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{0}}}{\begin{array}{ll}\multicolumn{2}{l}{\uncurry{(\mathrel{\wedge})}\comp (\neg \comp \Varid{sep}\times\p1)\comp (\Varid{id}\times\conj{\Varid{look}}{\Varid{wc\char95 w}})\to }\\& \succ \comp \p2\comp \p2\comp (\Varid{id}\times\conj{\Varid{look}}{\Varid{wc\char95 w}}),\\& \p2\comp \p2\comp (\Varid{id}\times\conj{\Varid{look}}{\Varid{wc\char95 w}})\end{array}}}
\just={ 2ª Lei de Fusão do Condicional (32)}
        \ensuremath{\Varid{wc\char95 w}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{0}}}{(\mcond{(\uncurry{(\mathrel{\wedge})}\comp (\neg \comp \Varid{sep}\times\p1))}{(\succ \comp \p2\comp \p2)}{(\p2\comp \p2)})\comp (\Varid{id}\times\conj{\Varid{look}}{\Varid{wc\char95 w}})}}
\just={ Absorção- + (22)}
        \ensuremath{\Varid{wc\char95 w}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{0}}}{\mcond{(\uncurry{(\mathrel{\wedge})}\comp (\neg \comp \Varid{sep}\times\p1))}{(\succ \comp \p2\comp \p2)}{(\p2\comp \p2)}}\comp (\Varid{id}\mathbin{+}(\Varid{id}\times\conj{\Varid{look}}{\Varid{wc\char95 w}}))}
\end{eqnarray*}
...
\begin{eqnarray*}
\start
        \ensuremath{\begin{lcbr}\Varid{look}\comp \Varid{nil}\mathrel{=}\Conid{True}\\\Varid{look}\comp \Varid{cons}\mathrel{=}\Varid{sep}\;\Varid{c}\end{lcbr}}
\just={ Eq-+ (27), fusão-+(20), Natural-\ensuremath{\p1}(12) }
        \ensuremath{\Varid{look}\comp \mathbf{in}\mathrel{=}\alt{\Conid{True}}{\Varid{sep}\comp \p1}}
\just={ Eq- + (27)}
        \ensuremath{\Varid{look}\comp \mathbf{in}\mathrel{=}\alt{\Conid{True}}{\Varid{sep}\comp \p1}}
\just={ Natural-\ensuremath{\p1} (12)}
        \ensuremath{\Varid{look}\comp \mathbf{in}\mathrel{=}\alt{\Conid{True}}{\p1\comp (\Varid{sep}\times\Varid{look})}}
\just={ Natural\_id (1) Absorção- + (22)}
        \ensuremath{\Varid{look}\comp \mathbf{in}\mathrel{=}\alt{\Conid{True}}{\p1}\comp (\Varid{id}\mathbin{+}(\Varid{sep}\times\Varid{look}))}
\just={ \ensuremath{\Varid{look}\mathrel{=}\p1\comp \conj{\Varid{look}}{\Varid{wc\char95 w}}}}
        \ensuremath{\Varid{look}\comp \mathbf{in}\mathrel{=}\alt{\Conid{True}}{\p1}\comp (\Varid{id}\mathbin{+}(\Varid{sep}\times\p1\comp \conj{\Varid{look}}{\Varid{wc\char95 w}}))}
\just={ Natural\_id (1), Functor-x (14)}
        \ensuremath{\Varid{look}\comp \mathbf{in}\mathrel{=}\alt{\Conid{True}}{\p1}\comp (\Varid{id}\mathbin{+}(\Varid{sep}\times\p1)\comp (\Varid{id}\times\conj{\Varid{look}}{\Varid{wc\char95 w}}))}
\just={ Functor-+ (25)}
        \ensuremath{\Varid{look}\comp \mathbf{in}\mathrel{=}\alt{\Conid{True}}{\p1}\comp (\Varid{id}\mathbin{+}(\Varid{sep}\times\p1))\comp (\Varid{id}\mathbin{+}(\Varid{id}\times\conj{\Varid{look}}{\Varid{wc\char95 w}}))}
\just={ Absorção-+ (22)}
        \ensuremath{\Varid{look}\comp \mathbf{in}\mathrel{=}\alt{\Conid{True}}{\p1\comp (\Varid{sep}\times\p1)}\comp (\Varid{id}\mathbin{+}(\Varid{id}\times\conj{\Varid{look}}{\Varid{wc\char95 w}}))}
\just={ Natural-\ensuremath{\p1} (12) }
        \ensuremath{\Varid{look}\comp \mathbf{in}\mathrel{=}\alt{\Conid{True}}{\Varid{sep}\comp \p1}\comp (\Varid{id}\mathbin{+}(\Varid{id}\times\p1\comp \conj{\Varid{look}}{\Varid{wc\char95 w}}))}
\end{eqnarray*}
...
\begin{eqnarray*}
wordAccum = \ensuremath{\conj{\Varid{sep}\comp \p1}{\mcond{(\uncurry{(\mathrel{\wedge})}\comp ((\neg \comp \Varid{sep})\times\p1))}{(\succ \comp \p2\comp \p2)}{(\p2\comp \p2)}}}
\end{eqnarray*}
...
\begin{eqnarray*}
\start
        \ensuremath{\begin{lcbr}\Varid{look}\comp \mathbf{in}\mathrel{=}\alt{\Conid{True}}{\Varid{sep}\comp \p1}\comp (\Varid{id}\mathbin{+}(\Varid{id}\times\conj{\Varid{look}}{\Varid{wc\char95 w}}))\\\Varid{wc\char95 w}\comp \mathbf{in}\mathrel{=}(\alt{\underline{\mathrm{0}}}{(\uncurry{(\mathrel{\wedge})}\comp (\neg \comp \Varid{sep}\times\p1))}\to \succ \comp \p2\comp \p2,\p2\comp \p2)\comp (\Varid{id}\mathbin{+}(\Varid{id}\times\conj{\Varid{look}}{\Varid{wc\char95 w}}))\end{lcbr}}
\just={ Fokkinga (50)}
        \ensuremath{\conj{\Varid{look}}{\Varid{wc\char95 w}}\mathrel{=}\Varid{cataList}\;\conj{\alt{\Conid{True}}{\Varid{sep}\comp \p1}}{\alt{\underline{\mathrm{0}}}{\uncurry{(\mathrel{\wedge})}\comp (\neg \comp \Varid{sep}\times\p1)\to \succ \comp \p2\comp \p2,\p2\comp \p2}}}
\just={ Lei da Troca (28)}
        \ensuremath{\conj{\Varid{look}}{\Varid{wc\char95 w}}\mathrel{=}\Varid{cataList}\;\alt{\conj{\Conid{True}}{\underline{\mathrm{0}}}}{\conj{\Varid{sep}\comp \p1}{\uncurry{(\mathrel{\wedge})}\comp (\neg \comp \Varid{sep}\times\p1)\to \succ \comp \p2\comp \p2,\p2\comp \p2}}}
\just={Def-split(78), def de wordAccum}
        \ensuremath{\conj{\Varid{look}}{\Varid{wc\char95 w}}\mathrel{=}\Varid{cataList}\;\alt{\underline{(\Conid{True},\mathrm{0})}}{\Varid{wordAccum}}}
\just={trivial}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{inB\char95 tree}\mathrel{=}\alt{\underline{\Conid{Nil}}}{\Varid{joinB\char95 trees}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{joinB\char95 trees}\mathbin{::}(\mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{a},[\mskip1.5mu (\Varid{a},\mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{a})\mskip1.5mu])\to \mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{joinB\char95 trees}\;(\Varid{t1},\Varid{ts})\mathrel{=}\Conid{Block}\;\{\mskip1.5mu \Varid{leftmost}\mathrel{=}\Varid{t1},\Varid{block}\mathrel{=}\Varid{ts}\mskip1.5mu\}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{tabbing}\tt
~inB\char95{}tree~\char58{}\char58{}~Either~\char40{}\char41{}~\char40{}B\char95{}tree~a\char44{}~\char91{}\char40{}a\char44{}~B\char95{}tree~a\char41{}\char93{}\char41{}~\char45{}\char62{}~B\char95{}tree~a\\
\tt ~inB\char95{}tree~\char61{}~either~\char40{}const~Nil\char41{}~\char40{}uncurry~Block\char41{}
\end{tabbing}

\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outB\char95 tree}\mathbin{::}\mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{a}\to ()+(\mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{a},[\mskip1.5mu (\Varid{a},\mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{a})\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{outB\char95 tree}\;\Conid{Nil}\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}\Varid{outB\char95 tree}\;(\Conid{Block}\;\Varid{left}\;\Varid{block})\mathrel{=}i_2\;(\Varid{left},\Varid{block}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{recB\char95 tree}\mathbin{::}(\Varid{b}\to \Varid{d})\to \Varid{z}+(\Varid{b},[\mskip1.5mu (\Varid{a},\Varid{b})\mskip1.5mu])\to \Varid{z}+(\Varid{d},[\mskip1.5mu (\Varid{a},\Varid{d})\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{recB\char95 tree}\;\Varid{f}\mathrel{=}\Varid{id}+(\Varid{f}\times(\map \;(\Varid{id}\times\Varid{f}))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{baseB\char95 tree}\mathbin{::}(\Varid{a1}\to \Varid{b1})\to (\Varid{a}\to \Varid{d})\to \Varid{b}+(\Varid{a},[\mskip1.5mu (\Varid{a1},\Varid{a})\mskip1.5mu])\to \Varid{b}+(\Varid{d},[\mskip1.5mu (\Varid{b1},\Varid{d})\mskip1.5mu]){}\<[E]%
\\
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{cataB\char95 tree}\mathbin{::}(()+(\Varid{d},[\mskip1.5mu (\Varid{a},\Varid{d})\mskip1.5mu])\to \Varid{d})\to \mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{a}\to \Varid{d}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{anaB\char95 tree}\mathbin{::}(\Varid{b}\to ()+(\Varid{b},[\mskip1.5mu (\Varid{a},\Varid{b})\mskip1.5mu]))\to \Varid{b}\to \mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{a}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{hyloB\char95 tree}\mathbin{::}(()+(\Varid{c},[\mskip1.5mu (\Varid{a},\Varid{c})\mskip1.5mu])\to \Varid{c})\to (\Varid{b}\to ()+(\Varid{b},[\mskip1.5mu (\Varid{a},\Varid{b})\mskip1.5mu]))\to \Varid{b}\to \Varid{c}{}\<[E]%
\\
...
\column{11}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment  esq meio dir}{}\<[E]%
\\
\>[B]{}\Varid{inordB\char95 tree}\mathbin{::}\mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{t}\to [\mskip1.5mu \Varid{t}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{inordB\char95 tree}\mathrel{=}\Varid{cataB\char95 tree}\;\Varid{inorder\char95 g}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{inorder\char95 g}\mathbin{::}()+([\mskip1.5mu \Varid{a}\mskip1.5mu],[\mskip1.5mu (\Varid{a},[\mskip1.5mu \Varid{a}\mskip1.5mu])\mskip1.5mu])\to [\mskip1.5mu \Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{inorder\char95 g}\mathrel{=}\alt{\underline{[\mskip1.5mu \mskip1.5mu]}}{\Varid{join}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{join}\mathbin{::}([\mskip1.5mu \Varid{a}\mskip1.5mu],[\mskip1.5mu (\Varid{a},[\mskip1.5mu \Varid{a}\mskip1.5mu])\mskip1.5mu])\to [\mskip1.5mu \Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{join}\;(\Varid{xs},\Varid{ys})\mathrel{=}\Varid{xs}\plus \Varid{concat}\;(\map \;(\lambda (\Varid{n},\Varid{zs})\to (\Varid{n}\mathbin{:}\Varid{zs}))\;\Varid{ys}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{largestBlock}\mathbin{::}\mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{t}\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{largestBlock}\mathrel{=}\Varid{cataB\char95 tree}\;\alt{\underline{\mathrm{0}}}{\Varid{size}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{size}\mathbin{::}(\Conid{Int},[\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu])\to \Conid{Int}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{size}\;(\Varid{x},\Varid{ys})\mathrel{=}\Varid{max}\;\Varid{x}\;(\length \;\Varid{ys}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{mirrorB\char95 tree}\mathbin{::}\mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{a}\to \mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{mirrorB\char95 tree}\mathrel{=}\Varid{cataB\char95 tree}\;(\Varid{inB\char95 tree}\comp (\Varid{id}+(\Varid{id}\times\Varid{reverse}))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\Varid{cB\char95 tree2Exp}\mathbin{::}\mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{a}\to \Conid{Exp}\;[\mskip1.5mu \Conid{Char}\mskip1.5mu]\;[\mskip1.5mu \Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{cB\char95 tree2Exp}\mathrel{=}\Varid{cataB\char95 tree}\;\alt{\underline{(\Conid{Var}\;\text{\tt \char34 nil\char34})}}{\Varid{connect}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{connect}\mathbin{::}(\Conid{Exp}\;\Varid{v}\;[\mskip1.5mu \Varid{a}\mskip1.5mu],[\mskip1.5mu (\Varid{a},\Conid{Exp}\;\Varid{v}\;[\mskip1.5mu \Varid{a}\mskip1.5mu])\mskip1.5mu])\to \Conid{Exp}\;\Varid{v}\;[\mskip1.5mu \Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{connect}\;(\Varid{x},\Varid{xs})\mathrel{=}\Conid{Term}\;\Varid{fsts}\;(\Varid{x}\mathbin{:}\Varid{snds}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;(\Varid{fsts},\Varid{snds})\mathrel{=}\Varid{unzip}\;\Varid{xs}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{qSortB\char95 tree}\mathrel{=}\Varid{hyloB\char95 tree}\;\Varid{inorder\char95 g}\;\Varid{lsplitB\char95 tree}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{lsplitB\char95 tree}\mathbin{::}\Conid{Ord}\;\Varid{a}\Rightarrow [\mskip1.5mu \Varid{a}\mskip1.5mu]\to ()+([\mskip1.5mu \Varid{a}\mskip1.5mu],[\mskip1.5mu (\Varid{a},[\mskip1.5mu \Varid{a}\mskip1.5mu])\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{lsplitB\char95 tree}\;[\mskip1.5mu \mskip1.5mu]{}\<[18]%
\>[18]{}\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}\Varid{lsplitB\char95 tree}\;(\Varid{x}\mathbin{:}\Varid{xs})\mathrel{=}i_2\;(\Varid{l1},[\mskip1.5mu (\Varid{x},\Varid{l2})\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;(\Varid{l1},\Varid{l2})\mathrel{=}\Varid{partB\char95 tree}\;(\mathbin{<}\Varid{x})\;\Varid{xs}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{partB\char95 tree}\mathbin{::}(\Varid{a}\to \Conid{Bool})\to [\mskip1.5mu \Varid{a}\mskip1.5mu]\to ([\mskip1.5mu \Varid{a}\mskip1.5mu],[\mskip1.5mu \Varid{a}\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{partB\char95 tree}\mathrel{=}\Varid{partition}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{t}\mathrel{=}\Conid{Block}\;\{\mskip1.5mu \Varid{leftmost}\mathrel{=}\Conid{Block}\;\{\mskip1.5mu \Varid{leftmost}\mathrel{=}\Conid{Nil},\Varid{block}\mathrel{=}[\mskip1.5mu (\mathrm{1},\Conid{Nil}),(\mathrm{2},\Conid{Nil}),(\mathrm{5},\Conid{Nil}),(\mathrm{6},\Conid{Nil})\mskip1.5mu]\mskip1.5mu\},\Varid{block}\mathrel{=}[\mskip1.5mu (\mathrm{7},\Conid{Block}\;\{\mskip1.5mu \Varid{leftmost}\mathrel{=}\Conid{Nil},\Varid{block}\mathrel{=}[\mskip1.5mu (\mathrm{9},\Conid{Nil}),(\mathrm{12},\Conid{Nil})\mskip1.5mu]\mskip1.5mu\}),(\mathrm{16},\Conid{Block}\;\{\mskip1.5mu \Varid{leftmost}\mathrel{=}\Conid{Nil},\Varid{block}\mathrel{=}[\mskip1.5mu (\mathrm{18},\Conid{Nil}),(\mathrm{21},\Conid{Nil})\mskip1.5mu]\mskip1.5mu\})\mskip1.5mu]\mskip1.5mu\}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\ana{\cdot ~\cdot }_A\mathbin{::}(\Varid{a}\to 1+(\Varid{a},\Varid{b}))\to (\Varid{b}\to 1+\Varid{a})\to \Varid{a}\to \Conid{A}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\ana{\cdot ~\cdot }_B\mathbin{::}(\Varid{a}\to 1+(\Varid{a},\Varid{b}))\to (\Varid{b}\to 1+\Varid{a})\to \Varid{b}\to \mathit B{}\<[E]%
\\
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{ga}\mathbin{::}\Conid{Int}\to 1+\Conid{Int}\times\Conid{Int}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{ga}\;\mathrm{0}\mathrel{=}i_1\;(){}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{ga}\;\Varid{n}\mathrel{=}i_2\;(\Varid{pred}\;\Varid{n},\Varid{pred}\;\Varid{n}){}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{gb}\mathbin{::}\Conid{Int}\to 1+\Conid{Int}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{gb}\;\mathrm{0}\mathrel{=}i_1\;(){}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{gb}\;\Varid{n}\mathrel{=}i_2\;(\Varid{pred}\;\Varid{n}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{showAlgae}\mathbin{::}\Conid{Algae}\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{showAlgae}\mathrel{=}\cata{\Varid{ga}~\Varid{gb}}_A{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{ga}\mathbin{::}\Varid{a}+(\Conid{String},\Conid{String})\to \Conid{String}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{ga}\mathrel{=}\alt{\underline{\text{\tt \char34 A\char34}}}{\uncurry{(\plus )}}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{gb}\mathbin{::}\Varid{a}+\Conid{String}\to \Conid{String}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{gb}\mathrel{=}\alt{\underline{\text{\tt \char34 B\char34}}}{\Varid{id}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{prop\char95 algae}\mathbin{::}\Conid{Property}{}\<[E]%
\\
\>[B]{}\Varid{prop\char95 algae}\mathrel{=}\Varid{forAll}\;(\Varid{elements}\;[\mskip1.5mu \mathrm{0}\mathinner{\ldotp\ldotp}\mathrm{25}\mskip1.5mu])\mathbin{\$}\lambda \Varid{n}\to (\length \comp \Varid{showAlgae}\comp \Varid{generateAlgae})\;\Varid{n}\equiv (\Varid{fromIntegral}\;((\Varid{fib}\comp \succ )\;(\Varid{fromIntegral}\;\Varid{n}))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{permuta}\;\Varid{input}\mathrel{=}\mathbf{do}{}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}(\Varid{x},\Varid{xs})\leftarrow \Varid{getR}\;\Varid{input}{}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\Varid{permuted}\leftarrow \Varid{permuta}\;\Varid{xs}{}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\Varid{return}\;(\Varid{x}\mathbin{:}\Varid{permuted}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{eliminatoria}\mathrel{=}\Varid{cataLTree}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{g}\mathbin{::}\Conid{Equipa}+(\fun{Dist}\;\Conid{Equipa},\fun{Dist}\;\Conid{Equipa})\to \fun{Dist}\;\Conid{Equipa}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{g}\mathrel{=}\alt{\Varid{return}}{\Varid{distJogo}}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{distJogo}{}\<[21]%
\>[21]{}\mathbin{::}(\fun{Dist}\;\Conid{Equipa},\fun{Dist}\;\Conid{Equipa})\to \fun{Dist}\;\Conid{Equipa}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{distJogo}\;(\Varid{de1},\Varid{de2})\mathrel{=}\mathbf{do}{}\<[E]%
\\
\>[11]{}\hsindent{22}{}\<[33]%
\>[33]{}e_1 \leftarrow \Varid{de1}{}\<[E]%
\\
\>[11]{}\hsindent{22}{}\<[33]%
\>[33]{}e_2 \leftarrow \Varid{de2}{}\<[E]%
\\
\>[11]{}\hsindent{22}{}\<[33]%
\>[33]{}\Varid{jogo}\;(e_1 ,e_2 ){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
