...
worker []                      = []
worker [c]
    \ensuremath{\neg \;(\Varid{sep}\;\Varid{c})\mathrel{=}[\mskip1.5mu \mathrm{1}\mskip1.5mu]} otherwise   = [0]
worker (c1:c2:cs)
    \ensuremath{\neg \;(\Varid{sep}\;\Varid{c1})\mathrel{\wedge}\Varid{sep}\;(\Varid{c2})\mathrel{=}\mathrm{1}\mathbin{:}\Varid{worker}\;(\Varid{c2}\mathbin{:}\Varid{cs})} otherwise                = 0 : worker (c2:cs)
